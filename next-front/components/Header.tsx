    ...
    <header className="border-b-4 border-double border-stone-800 bg-[#14110f] sticky top-0 z-50 shadow-2xl">
      <div className="max-w-full px-8 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="relative bg-stone-900 border-2 border-stone-700 p-2 rounded-md rotate-3">
            <Sword size={24} className="text-amber-600" />
          </div>
          <div>
            <h1 className="text-2xl font-black tracking-widest uppercase italic text-stone-100 drop-shadow-lg">
              Arena <span className="text-amber-700">Mayhem</span>
            </h1>
            <p className="text-[10px] tracking-[0.3em] uppercase text-stone-500 font-sans">
        ...
        {!connected ? (
          <button
            onClick={connect}
            className="flex items-center gap-2 bg-amber-900 hover:bg-amber-800 text-amber-100 px-6 py-2 font-bold border-b-4 border-amber-950 active:border-b-0 active:translate-y-0.5 transition-all shadow-lg uppercase tracking-wider text-sm"
          >
            <Sword size={14} /> Connect Signet
          </button>
        ) : (
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-2 bg-stone-900 border border-stone-800 px-3 py-1.5 rounded">
              <div className="w-2 h-2 rounded-full bg-green-900 animate-pulse border border-green-500" />
              <span className="text-[10px] text-stone-500 uppercase font-bold">Connected</span>
            </div>
            <button
              onClick={disconnect}
